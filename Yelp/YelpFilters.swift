...
class YelpFilters {
    ...
    static let sharedInstance = YelpFilters()
    ...
    func sortModes() -> [NSDictionary] {
        return [["title": "Best Match", "value": YelpSortMode.best_match.rawValue],
                ["title": "Distance", "value": YelpSortMode.distance.rawValue],
                ["title": "Highest Rated", "value": YelpSortMode.rating.rawValue],
                ["title": "Number of Reviews", "value": YelpSortMode.review_count.rawValue]]
    }
